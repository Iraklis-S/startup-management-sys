...
@section('content')
    <h1 class="h3 mb-4">Shto Blerje</h1>
            ...
            <form method="POST" action="{{ route($route . '.store') }}">
                ...
                <div class="mb-3">
                    ...
                    <select name="acquiring_company_id" class="form-select searchable-select" data-placeholder="Kërkoni..." required>
                        ...
                        @foreach($kompanite as $kompani)
                            <option value="{{ $kompani->id }}" {{ old('acquiring_company_id') == $kompani->id ? 'selected' : '' }}>{{ $kompani->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <select name="acquired_company_id" class="form-select searchable-select" data-placeholder="Kërkoni..." required>
                        <option value=""></option>
                        @foreach($kompanite as $kompani)
                            <option value="{{ $kompani->id }}" {{ old('acquired_company_id') == $kompani->id ? 'selected' : '' }}>{{ $kompani->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" name="price_amount" class="form-control" value="{{ old('price_amount') }}">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="price_currency_code" class="form-control" value="{{ old('price_currency_code') }}" placeholder="USD, EUR">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="acquired_at" class="form-control" value="{{ old('acquired_at') }}">
...
@endsection
                    <div class="mb-3">
                        ...
                        <input type="text" name="price_currency_code" class="form-control" value="{{ old('price_currency_code') }}">
                        @error('price_currency_code')<div class="form-text text-danger">{{ $message }}</div>@enderror
                    </div>
                </div>
            </div>
